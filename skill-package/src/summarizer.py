...
class ArticleSummarizer:
    ...
    def _summarize_single(self, article: Dict) -> Optional[str]:
        ...
        Args:
            article: 文章字典，需要包含 title 和 content
    ...
    def _build_prompt(self, title: str, content: str) -> str:
        ...
        prompt = f"""请用中文总结以下文章内容，提取核心要点，并使用简洁的 HTML 格式输出。重要要求：

1. 如果文章标题是英文，请翻译成中文
2. 如果文章内容是英文，请理解后翻译成中文进行总结
3. 用简洁、清晰的语言概括主要内容
4. 对于要点列表，使用 <ul> 和 <li> 标签（无序列表）
5. 如果要点有明确的顺序，使用 <ol> 和 <li> 标签（有序列表）
6. 使用 <strong> 标签强调关键术语或重要概念
7. 摘要长度控制在 150-200 字之间
8. 不要添加原文没有的信息或个人观点
9. 保持客观、中立的语气
